<?php
	class CashFlow extends SnlActiveRecord {
		public $cashflow_id, $type, $description, $nominal, $created_on, $created_by, $updated_on, $updated_by, $is_deleted;

		public function __construct() {
		    $this->classname = 'CashFlow';
			$this->table_name = 'tbl_cashflow';
			$this->primary_key = 'cashflow_id';
		}

		public function rules() {
			return array(
				'required'	=> array('type', 'description', 'nominal'),
			);
		}
